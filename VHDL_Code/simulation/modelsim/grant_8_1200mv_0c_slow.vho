...
SIGNAL \U1|i[4]~8_combout\ : std_logic;
...
-- Equation(s):
-- \U2|count_baud[8]~25_combout\ = \U2|count_baud\(8) $ (!\U2|count_baud[7]~24\)
...
-- Equation(s):
-- \U2|LessThan0~1_combout\ = (!\U2|count_baud\(0) & (!\U2|count_baud\(3) & (!\U2|count_baud\(2) & !\U2|count_baud\(1))))
...
PORT MAP (
	...
	datac => \U2|count_baud\(6),
	datad => \U2|count_baud\(7),
...
-- Equation(s):
-- \U2|count_os[0]~5_combout\ = (((\U2|count_os\(0) & \U2|LessThan0~2_combout\)))
-- \U2|count_os[0]~6\ = CARRY((\U2|count_os\(0) & \U2|LessThan0~2_combout\))
...
-- Equation(s):
-- \U2|count_os[1]~7_combout\ = (\U2|count_os[0]~6\ & (((!\U2|LessThan0~2_combout\)) # (!\U2|count_os\(1)))) # (!\U2|count_os[0]~6\ & (((\U2|count_os\(1) & \U2|LessThan0~2_combout\)) # (GND)))
-- \U2|count_os[1]~8\ = CARRY(((!\U2|count_os[0]~6\) # (!\U2|LessThan0~2_combout\)) # (!\U2|count_os\(1)))
...
-- Equation(s):
-- \U2|count_os[2]~9_combout\ = (\U2|count_os[1]~8\ & (\U2|count_os\(2) & (\U2|LessThan0~2_combout\ & VCC))) # (!\U2|count_os[1]~8\ & ((((\U2|count_os\(2) & \U2|LessThan0~2_combout\)))))
-- \U2|count_os[2]~10\ = CARRY((\U2|count_os\(2) & (\U2|LessThan0~2_combout\ & !\U2|count_os[1]~8\)))
...
-- Equation(s):
-- \U2|count_os[3]~11_combout\ = (\U2|count_os[2]~10\ & (((!\U2|LessThan0~2_combout\)) # (!\U2|count_os\(3)))) # (!\U2|count_os[2]~10\ & (((\U2|count_os\(3) & \U2|LessThan0~2_combout\)) # (GND)))
-- \U2|count_os[3]~12\ = CARRY(((!\U2|count_os[2]~10\) # (!\U2|LessThan0~2_combout\)) # (!\U2|count_os\(3)))
...
-- Equation(s):
-- \U2|count_os[4]~13_combout\ = \U2|count_os[3]~12\ $ (((!\U2|LessThan0~2_combout\) # (!\U2|count_os\(4))))
...
-- Equation(s):
-- \U2|LessThan1~0_combout\ = (((!\U2|count_os\(2) & !\U2|count_os\(1))) # (!\U2|count_os\(3))) # (!\U2|count_os\(4))
...
-- Equation(s):
-- \U2|LessThan1~1_combout\ = (!\U2|LessThan1~0_combout\ & \U2|LessThan0~2_combout\)
...
-- Equation(s):
-- \U2|rx_count~0_combout\ = (!\U2|rx_count\(0) & \U2|rx_state~q\)
...
-- Equation(s):
-- \U2|os_count[2]~1_combout\ = (!\rx~input_o\ & (!\U2|os_count\(3) & !\U2|rx_state~q\))
...
-- Equation(s):
-- \U2|os_count[3]~2_combout\ = (\U2|os_count[3]~0_combout\ & ((\U2|os_count[2]~1_combout\) # ((\U2|LessThan3~0_combout\ & \U2|rx_state~q\))))
...
-- Equation(s):
-- \U2|os_count[2]~4_combout\ = (\U2|os_count[3]~0_combout\ & (\U2|Add2~1_combout\ & ((\U2|os_count[3]~2_combout\)))) # (!\U2|os_count[3]~0_combout\ & ((\U2|os_count\(2)) # ((\U2|Add2~1_combout\ & \U2|os_count[3]~2_combout\))))
...
-- Equation(s):
-- \U2|LessThan3~0_combout\ = (((!\U2|os_count\(2)) # (!\U2|os_count\(3))) # (!\U2|os_count\(0))) # (!\U2|os_count\(1))
...
-- Equation(s):
-- \U2|os_count[3]~3_combout\ = (\U2|os_count[3]~0_combout\ & (\U2|Add2~0_combout\ & ((\U2|os_count[3]~2_combout\)))) # (!\U2|os_count[3]~0_combout\ & ((\U2|os_count\(3)) # ((\U2|Add2~0_combout\ & \U2|os_count[3]~2_combout\))))
...
-- Equation(s):
-- \U2|rx_state~0_combout\ = (\U2|rx_busy~2_combout\) # ((\U2|rx_state~q\ & ((\U2|LessThan4~0_combout\) # (\U2|LessThan3~0_combout\))))
...
-- Equation(s):
-- \U1|i[4]~7_combout\ = (!\U2|tx_busy~q\) # (!\U1|sig_state.S2~q\)
...
\U1|i[4]~8\ : cycloneive_lcell_comb
-- Equation(s):
-- \U1|i[4]~8_combout\ = (\U1|Selector3~0_combout\) # ((!\U1|Equal0~0_combout\ & (\U1|i\(4) & !\U1|i[4]~7_combout\)))
...
PORT MAP (
	...
	datab => \U1|i\(4),
	datac => \U1|i[4]~7_combout\,
	datad => \U1|Selector3~0_combout\,
	combout => \U1|i[4]~8_combout\);
...
-- Equation(s):
-- \U1|Equal0~0_combout\ = (\U1|i\(0)) # ((\U1|i\(1)) # ((\U1|i\(2)) # (\U1|i\(3))))
...
-- Equation(s):
-- \U1|Selector1~2_combout\ = (\U1|Selector1~1_combout\) # ((\U1|Selector1~0_combout\) # ((\U1|sig_state.S2~q\ & !\U2|tx_busy~q\)))
...
-- Equation(s):
-- \U1|Selector2~1_combout\ = (\U1|Selector2~0_combout\) # ((\U2|tx_busy~q\ & (\U1|Selector1~1_combout\ & \U1|sig_state.S0~q\)))
...
-- Equation(s):
-- \U1|Selector3~0_combout\ = (\U1|state_of_rx_busy~q\ & (\U1|sig_state.S1~q\ & !\U2|rx_busy~q\))
...
-- Equation(s):
-- \U1|Selector3~1_combout\ = (\U1|Selector3~0_combout\) # ((\U1|sig_state.S2~q\ & !\U2|tx_busy~q\))
...
-- Equation(s):
-- \U2|tx_count[3]~1_combout\ = (\U1|tx_ena~q\) # (\U2|tx_state~q\)
...
-- Equation(s):
-- \U2|rx_buffer[1]~0_combout\ = (\reset~input_o\ & \U2|rx_state~q\)
...
-- Equation(s):
-- \U2|rx_buffer[1]~1_combout\ = (!\U2|LessThan3~0_combout\ & (\U2|os_pulse~q\ & (\U2|rx_buffer[1]~0_combout\ & \U2|LessThan4~0_combout\)))
...
PORT MAP (
	dataa => \U2|LessThan3~0_combout\,
	datab => \U2|os_pulse~q\,
	datac => \U2|rx_buffer[1]~0_combout\,
...
-- Equation(s):
-- \U2|rx_data[0]~0_combout\ = (!\U2|LessThan4~0_combout\ & (\U2|os_pulse~q\ & (\U2|rx_state~q\ & !\U2|LessThan3~0_combout\)))
...
-- Equation(s):
-- \U1|secret[0]~0_combout\ = (!\U1|sig_state.S0~q\ & (\U1|state_of_rx_busy~q\ & !\U2|rx_busy~q\))
...
-- Equation(s):
-- \U1|Mux0~2_combout\ = (\U1|i\(1) & (\U1|i\(2))) # (!\U1|i\(1) & ((\U1|i\(2) & ((\U1|secret\(1)))) # (!\U1|i\(2) & (\U1|secret\(3)))))
...
-- Equation(s):
-- \U1|tx_data~1_combout\ = (\U1|tx_data~0_combout\) # ((\U1|i\(3) & (\U1|i\(0) & \U1|Mux0~3_combout\)))
...
-- Equation(s):
-- \U2|tx_parity[8]~1_combout\ = \U1|tx_data\(2) $ (\U1|tx_data\(1) $ (\U1|tx_data\(3) $ (\U1|tx_data\(0))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U2|tx_parity[8]~0_combout\,
	datac => \U2|tx_state~q\,
